...
# flashcard_mode.py
#
# One‐by‐one Flashcard Mode (with an explicit “Next Question” button):
# - Shows one random unanswered question from today’s slice of 40.
# - User must select at least one checkbox, or they get a warning.
# - After submitting a valid answer:
#     • Feedback appears immediately on the same page (✅/❌ + correct answer(s)).
#     • A “Next Question” button appears underneath that feedback.
#     • Only when the user clicks “Next Question” does the next random
#       unanswered question appear.
# - Tracks “rounds” (submissions) in session_state["rounds"].
# ───────────────────────────────────────────────────────────────────────────────
